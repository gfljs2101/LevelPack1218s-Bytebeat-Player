export const splashes = [
    ...
    "Go away, exotic modes and functions! GO AWAY!<br> &mdash;Chasyxx",
    ...
    "Metal pipe moment",
    'See an issue? <a href="https://github.com/GFLJS2101/LevelPack1218s-Bytebeat-Player/issues" target="_blank">Let me know!!</a>',
    ...
    "Creator &mdash; and DESTROYER &mdash; of triads!<br> &mdash;Chasyxx",
    "Creator of the zoom indicator!<br> &mdash;Chasyxx",
    "96kHz samplerate!",
    "Cookie?",
    "Change is OK!",
